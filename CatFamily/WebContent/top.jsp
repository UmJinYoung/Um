...
<center>
   <div align="right" class="fixed-title">
    <c:if test="${sessionScope.sessionID!=null}">
       <font style='font-size:11pt; color:black'> 아이디 :</font><font style='font-size:11pt; color:red'> [</font> <font style='font-size:11pt; color:black'><%=session.getAttribute("sessionID")%></font> <font style='font-size:11pt; color:red'> ] </font>
       <input type="button" value="회원정보수정" onclick="location.href='member.jsp?idx=${sessionScope.sessionID}'" style="font-size:11px"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <p>
...
<div align="center" class="fixed-menu">
  <a href="catmain.jsp" style="text-decoration:none"><legend class="title">CATFAMILY</legend></a>
  <nav id="topMenu">
    <ul>
    ...
    <c:if test ="${sessionScope.sessionID==null}">      
      ...
      <li>|</li>
      <li><a class='menuLink' href='catjoin.jsp'>회원가입</a></li>
      <li>|</li>
      <li><a class='menuLink' href='catlogin.jsp'>로그인</a></li>
      
      
    </c:if>
    <c:if test ="${sessionScope.sessionID!=null && sessionScope.sessionID!='catid'}">    
