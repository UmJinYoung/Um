...
public class qaController extends HttpServlet {
  ...
  public void doUser(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {	
	...
	//������������ 316/10
	DBDAO dao=new DBDAO();
	int Gtotal=dao.dbCount(listOpt);
	...
	int comment_qanum=bean.getComment_qanum();
	System.out.println("댓글 수:"+comment_qanum);
//	int ReplyCount=comment.getReplyCount(comment_qanum);
	
	
	ArrayList<DBbean> LG = dao.dbSelect(start, end, listOpt);
//	request.setAttribute("ReplyCount", ReplyCount);
	...
	request.setAttribute("qa", LG);
	request.setAttribute("Gtotal", Gtotal);
	//LG,Gtotal �������������͸�   view������ �Ѱܿ�
	//���������� ���������� requestȰ��, guestList.jsp���� ȣ���� ������
	RequestDispatcher dis=request.getRequestDispatcher("qaList.jsp");
